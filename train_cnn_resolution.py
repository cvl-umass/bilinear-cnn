...
import time
import shutil
from CNN_downsample import create_cnn_model
from test import test_model
from plot_curve import plot_log
import json

# The difference of this script from 'train_cnn.py' is that this script uses
# the input of native resolution for inat. Another difference is that this 
# provides the ResNet models with downsampling within the network.
...
def main(args):
    ...
    if args.dataset == 'cub':
        ...
        dset_root['inat'] = os.path.join(os.path.dirname(dset_root['inat']),
                                        'inat_2018')
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dsmp_method', default='avg',
            type=str, help='downsmampling method')
